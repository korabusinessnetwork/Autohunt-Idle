...
| P5 | **Fortificação de item por RNG** (`specs/fortificacao-de-item.md`) | Pedido em 2026-08-11. O conflito de pagamento foi **resolvido**: custa ouro, e a loja vende ouro por diamante em quantidade fixa — a compra deixa de ser o sorteio, que é o que muda a natureza da coisa. **Continua em aberto:** falhar rebaixa o item ou só gasta o material? Rebaixar contradiz "progresso nunca é punido", o mesmo princípio que já cortou o permadeath. |
| P6 | **Preço da fortificação em ouro é condição de compliance, não só de diversão** | Se o custo for calibrado para forçar a compra de ouro, o caminho gratuito vira fachada e a estrutura volta a ser recompensa aleatória paga. Precisa ser revisado quando houver dado de quanto ouro um jogador ganha por hora. |
