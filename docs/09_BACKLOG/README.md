...
| D11 | **4 ameaças seguem ABERTAS, nenhuma por falta de código** | RLS sob JWT real (só num Supabase de verdade), calibragem do preço da fortificação (P6), webhook de gateway (P3) e replay de callback de anúncio (P2). Listadas com impacto em `docs/11_SEGURANCA/README.md`. |
