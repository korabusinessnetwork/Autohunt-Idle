...
export const en: Record<ChaveI18n, string> = {
  ...
  'hud.auto.desligado': "You're driving",
  'hud.auto.saldo': '{minutos} min of autopilot',
  'hud.auto.bloqueado': 'Autopilot needs an ad or a subscription',
  "ocioso.titulo": 'You took a break',
  "ocioso.explicacao": "You were idle for a bit, so the game stopped here. Nothing you'd already earned was lost.",
