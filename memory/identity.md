...
- **Fase 3 (Expansão, guiada pelo que a Fase 2 mostrar)**: dungeon/raridade/skin, passe, atributo completo + ranking global, equipamento/poder com conjunto, diamante + mercado P2P, 8 biomas — não necessariamente todas, nem nessa ordem; entram conforme o que os dados de jogador real justificarem
